...
[Serializable]
struct packet_sparkles {
	public int countryId;

	public packet_sparkles(int c) {
		countryId = c;
	}
}

[Serializable]
struct packet_cursor_team {
	public team_id teamId;
	public int countryId;

	public packet_cursor_team(team_id tid, int cid) {
		teamId = tid;
		countryId = cid;
	}
}
...
[Serializable]
public struct packet_bridge {
	public team_id team;
	public int country;
	public int level;

	public packet_bridge(team_id t, int c, int l) {
		team = t;
		country = c;
		level = l;
	}
...
[Serializable]
public struct packet_scores {
	public int[] scores;
	public team_id winner;
	public string[] names;

	public packet_scores(int[] s, team_id t, string[] ns) {
		scores = s;
		winner = t;
		names = ns;
	}
